...
if (fs.existsSync(colorsFileLocation)) fs.unlinkSync(colorsFileLocation);
...
css_string_component += `--main-background-color: #0C0C0D;\n`;
...
config['_inputs']['color_group']['options']['values'].push({
  id: 'primary',
...
config['_inputs']['card_color_group']['options']['values'] = Array.from(
  config['_inputs']['color_group']['options']['values'],
);
config['_inputs']['nav_color_group']['options']['values'] = Array.from(
  config['_inputs']['color_group']['options']['values'],
);
config['_inputs']['footer_color_group']['options']['values'] = Array.from(
  config['_inputs']['color_group']['options']['values'],
);
